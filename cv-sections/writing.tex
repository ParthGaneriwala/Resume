...
{Formalizing Natural Language Specifications for MBSE with an NLP-Based Grammar for Automated System Architecture Generation}
{Under Review}
...
% }
\cventry
{\textbf{P Ganeriwala}, C Chambers, JI Lathrop, S Bhattacharyya, J Babar, S Gilbert, I Amundson, M Dorneich and MAH Khan}
{\href{https://link.springer.com/chapter/10.1007/978-3-032-28079-4_9}{Formal Analysis of Stochastic Cognitive Models: A Translation Framework from Soar to PRISM}}
{Accepted}
...
{Compositional Reasoning over System Architectures with Integrated Cognitive Model}
{Accepted}
{IEEE SysCon 2026} 
{ % Description(s)
\begin{cvitems}
...
{Correlation-Threshold Feature Selection for Internet of Things (IoT) Device Identification under Domain Shift}
{Accepted}
{ISAIM 2026} 
{ % Description(s)
\begin{cvitems}
...
{\href{https://arc.aiaa.org/doi/abs/10.2514/6.2026-1774}{AssistTaxi-v2: A Scalable Dataset for Taxiway/Runway Scene Understanding Under Diverse Conditions}}
{Accepted}
{AIAA SciTech 2026} 
{ % Description(s)
\begin{cvitems}
...
\cventry
{\textbf{P Ganeriwala}, C Chambers, S Bhattacharyya, and J Babar}
{\href{https://loonwerks.com/publications/ganeriwala2025ersa.html}{Explainable Assurance through Compositional Verification with Cognitive Models}}
{Accepted}
{IEEE RTSS/ESRA 2025} 
{ % Description(s)
\begin{cvitems}
...
{\href{https://ieeexplore.ieee.org/document/11249949}{Integrating Reconfigurable Accelerators with Quantum Computing}}
{Accepted}
...
{\href{https://openaccess.thecvf.com/content/ICCV2025W/2COOOL/html/Khan_Adapt_But_Dont_Forget_Fine-Tuning_and_Contrastive_Routing_for_Lane_ICCVW_2025_paper.html}{
...
{	
\href{https://sint4ch.fbk.eu/program}{FLAIR: Few-Shot Learning for Grapheme Recognition in Ancient Scripts}}
{Accepted}
...
\cventry
{\textbf{P Ganeriwala} and D Mitra}
{\href{https://dl.acm.org/doi/10.1145/3773290}{	
...
{\href{https://ieeexplore.ieee.org/document/11257175}{Modeling and Formal Analysis of High-Assurance Mixed-Reality Systems}}
{Accepted}
{AIAA DATC/IEEE DASC 2025} 
{ % Description(s)
\begin{cvitems}
\end{cvitems}
}
...
{\href{https://ieeexplore.ieee.org/document/11014784}{Design and Validation of Learning Aware HMI for Learning-Enabled Increasingly Autonomous Systems}}
{Accepted}
{IEEE SysCon 2025} 
{ % Description(s)
\begin{cvitems}
...
\cventry
% % {Fitzroy Nembhard, Marco Carvalho}
{\textbf{P Ganeriwala}, S Bhattacharyya and R Muthalagu}
{\href{https://ieeexplore.ieee.org/abstract/document/10186721}{Cross Dataset Analysis and Network Architecture Repair for Autonomous Car Lane Detection}}
{Accepted}
...
\cventry
{\textbf{P Ganeriwala}, C Chambers, C Sen and S Bhattacharyya}
