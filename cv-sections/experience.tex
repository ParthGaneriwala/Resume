...
{
\begin{cvitems}
  \item \textbf{[CONFIRM: add Software Engineer II responsibilities/achievements here]}
\end{cvitems}
}
\cventry
...
\begin{cvitems}
  ...
  \item Developed, integrated, and debugged \textbf{C-based flight software modules} in the avionics stack, ensuring compliance with real-time, safety-critical, and \textbf{DO-178C} guidelines.
  ...
  \item Led integration of multiple avionics product test suites into a \textbf{common extensible E2TE framework}, improving scalability and enabling rapid onboarding of new flight platforms.
  \item Built and maintained \textbf{embedded Linux software images} for avionics hardware using \textbf{Poky/Yocto build systems}, supporting cross-compilation and deployment across multiple flight product lines.
  \item Performed \textbf{low-level firmware flashing, hardware bring-up, and software deployment} onto flight test boxes, ensuring reliable integration between embedded targets and avionics simulation environments.
  \item Executed \textbf{hardware-in-the-loop (HIL) simulations}, diagnosing runtime and interface-level issues to improve simulation-to-aircraft fidelity by 10\%.
  \item Supported avionics certification efforts by contributing to the \textbf{ASTM TFC compliance process} for \href{https://www.avidyne.com/shop/vantage/vantage-flight-display-systems-solutions/}{\textbf{Vantage12 certification}}, aligning embedded workflows with industry verification standards.
