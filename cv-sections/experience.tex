...
{
\begin{cvitems}
  \item Design and implement \textbf{embedded software} using \textbf{C++}.
  \item Develop features across \textbf{operating system services}, \textbf{device drivers}, and \textbf{touchscreen-based user interfaces}.
  \item Collaborate with test and systems engineers to ensure smooth integration and functional alignment.
  \item Conduct \textbf{unit and integration testing}; support system verification in accordance with \textbf{FAA} and internal standards.
  \item Maintain traceability between requirements and implementation using tools such as \textbf{DOORS}.
  \item Contribute to engineering documentation and release deliverables.
  \item Maintain and enhance development tools and automation frameworks.
  \item Support onboarding and mentor junior engineers and interns, contributing to a culture of learning and technical excellence.
\end{cvitems}
}
\cventry
...
{Software and Systems Engineering, \href{https://www.avidyne.com/}{Avidyne}}
{\textbf{Melbourne, FL}}
{\textbf{August 2025 – May 2026}}
{
\begin{cvitems}
  \item Advanced \textbf{end-to-end (E2E) test and evaluation (E2TE)} workflows by expanding coverage to include advanced flight management and communication systems, achieving an overall \textbf{25\% increase} in test coverage.
  \item Developed, integrated, and debugged \textbf{C-based flight software} in the avionics stack, ensuring compliance with real-time, safety-critical, and \textbf{DO-178C} guidelines for production-ready systems.
  \item Merged product test libraries across multiple avionics platforms, creating a unified cross-product testing infrastructure that improved code reusability and maintenance efficiency by \textbf{30\%}.
  \item Enhanced automation capabilities by developing \textbf{C and Visual Basic test scripts} for complex regression and validation processes, accelerating simulation turnaround by \textbf{20\%} and enabling seamless cross-product test execution.
  \item Executed \textbf{hardware-in-the-loop (HIL) simulations} using proprietary avionics simulation frameworks, diagnosing and resolving complex execution issues to improve simulation-to-aircraft fidelity by \textbf{10\%}.
  \item Contributed to flight code development for Avidyne’s \href{https://quantum.avidyne.com/}{\textbf{Quantum Open Avionics Platform}}, supporting rapid prototyping of next-generation avionics solutions and enabling faster deployment cycles.
\end{cvitems}
}
\cventry
...
{Software and Systems Engineering, \href{https://www.avidyne.com/}{Avidyne}}
{\textbf{Melbourne, FL}}
{\textbf{May 2025 – August 2025}}
{
\begin{cvitems}
  \item Designed and executed \textbf{end-to-end (E2E) test and evaluation (E2TE)} workflows for \textbf{aviation simulation software}, increasing test coverage across navigation, communication, and flight display systems by \textbf{25\%}.
  \item Created and optimized \textbf{30+ system-level and flight-specific test cases} in simulation environments, focusing on core avionics functionality and reducing initial verification cycle time by \textbf{10\%}.
  \item Developed \textbf{TFC (Test Framework Core)} software tests to validate critical flight system components and ensure consistent testing methodologies across simulation platforms.
  \item Automated initial regression processes by writing \textbf{Visual Basic} test scripts, improving basic simulation validation efficiency by \textbf{15\%}.
  \item Utilized industry-standard tools — \textbf{Perforce (P4)} and \textbf{Visual Studio} — to support development workflows and maintain version control across testing frameworks.
\end{cvitems}
}
\cventry
{Research Scholar}
