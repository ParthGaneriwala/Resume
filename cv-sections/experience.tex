...
\begin{cvitems}
  ...
  \item Partner with test and systems engineers to align software integration with system-level functional requirements.
  ...
  \item Maintain requirements-to-implementation traceability using \textbf{DOORS} to support certification audits.
  \item Author engineering documentation and release deliverables for each software build.
  \item Enhance internal development tools and automation frameworks, improving efficiency for the broader engineering team.
  \item Mentor junior engineers and interns, guiding onboarding and technical growth.
\end{cvitems}
}
\cventry
...
\begin{cvitems}
  ...
  \item Consolidated product test libraries across multiple avionics platforms into a unified cross-product testing infrastructure, improving code reusability and maintenance efficiency by \textbf{30\%}.
  \item Automated regression and validation testing by writing \textbf{C and Visual Basic} test scripts (managed via \textbf{Perforce} and \textbf{Visual Studio}), cutting simulation turnaround time by up to \textbf{20\%}.
  \item Diagnosed and resolved execution issues in \textbf{hardware-in-the-loop (HIL) simulations} using proprietary avionics simulation frameworks, improving simulation-to-aircraft fidelity by \textbf{10\%}.
  \item Contributed to flight code development for Avidyne’s \href{https://quantum.avidyne.com/}{\textbf{Quantum Open Avionics Platform}}, supporting rapid prototyping of next-generation avionics solutions.
\end{cvitems}
}
\cventry
{Research Scholar}
